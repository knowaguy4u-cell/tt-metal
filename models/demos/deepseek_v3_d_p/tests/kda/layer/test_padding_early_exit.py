...
def test_padding_changing_interval_single_capture(mesh_device, sp_axis, tp_axis, device_params):
    ...
    layer = _build_layer(mesh_device, config, weights, sp_axis, tp_axis, summary_group_chunks=2)
    ...
    if p == 1:
        for length in (32, 96, 128, 224, sequence):
            ...
            trimmed_out, trimmed_state = layer.forward(trimmed_hidden, initial, start_tt)
