...
TEST_F(UnitMeshFastDispatchFixture, TensixDirectWritePerformanceComparison) {
    ...
    unit_tests::dm::direct_write::performance_comparison_test(get_mesh_device(), test_id, sender_core, *receiver_core);
}
...
TEST_F(UnitMeshFastDispatchFixture, TensixDirectWriteAddressPatterns) {
    ...
    unit_tests::dm::direct_write::address_pattern_test(get_mesh_device(), test_id, sender_core, *receiver_core);
}
